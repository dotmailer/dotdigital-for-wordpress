...
class Dotdigital_WordPress_Credentials_Admin implements Dotdigital_WordPress_Page_Tab_Interface {
	...
	public function initialise() {
		...
		$this->form->add_input(
			new Dotdigital_WordPress_Setting_Form_Password_Input(
				sprintf(
					'%s[%s]',
					Dotdigital_WordPress_Config::SETTING_CREDENTIALS_PATH,
	...
	public function render() {
		try {
			$account_info = array_reduce(
				$this->dotdigital_client->get_client()->accountInfo->show()->getProperties(),
	...
	public function save( $credentials = array() ) {
		...
		$credentials = array(
			Dotdigital_WordPress_Config::SETTING_CREDENTIALS_PATH_USERNAME =>
				trim( $credentials[ Dotdigital_WordPress_Config::SETTING_CREDENTIALS_PATH_USERNAME ] ),
			Dotdigital_WordPress_Config::SETTING_CREDENTIALS_PATH_PASSWORD =>
				trim( $credentials[ Dotdigital_WordPress_Config::SETTING_CREDENTIALS_PATH_PASSWORD ] ),
		);
