	...
	<div class="card w-100 widefat">
		<div class="inside">
			...
			<p><strong>Main account email address:</strong><br>
				<?php echo esc_html( $account_info['MainEmail'] ?? '--' ); ?>
			</p>
			<p><strong>API calls in last hour:</strong><br>
				<?php echo esc_html( $account_info['ApiCallsInLastHour'] ?? '--' ); ?>
			</p>
			<p><strong>API calls remaining:</strong><br>
				<?php echo esc_html( $account_info['ApiCallsRemaining'] ?? '--' ); ?>
			</p>
			<p><strong>API endpoint:</strong><br>
				<?php echo esc_html( $account_info['ApiEndpoint'] ?? '--' ); ?>
			</p>
		</div>
	</div>
</div>
