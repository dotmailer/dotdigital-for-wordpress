...
trait Dotdigital_WordPress_Interacts_With_Messages_Trait {
	...
	public function get_form_title(): string {
		return Dotdigital_WordPress_Config::get_option(
			Dotdigital_WordPress_Config::SETTING_MESSAGES_PATH . '[dm_API_form_title]'
		);
	}
	...
	public static function get_invalid_email_message(): string {
		return Dotdigital_WordPress_Config::get_option(
			Dotdigital_WordPress_Config::SETTING_MESSAGES_PATH . '[dm_API_invalid_email]'
		);
	}
	...
	public static function get_fill_required_message(): string {
		return Dotdigital_WordPress_Config::get_option(
			Dotdigital_WordPress_Config::SETTING_MESSAGES_PATH . '[dm_API_fill_required]'
		);
	}
	...
	public static function get_success_message(): string {
		return Dotdigital_WordPress_Config::get_option(
			Dotdigital_WordPress_Config::SETTING_MESSAGES_PATH . '[dm_API_success_message]'
		);
	}
	...
	public static function get_failure_message(): string {
		return Dotdigital_WordPress_Config::get_option(
			Dotdigital_WordPress_Config::SETTING_MESSAGES_PATH . '[dm_API_failure_message]'
		);
	}
	...
	public static function get_nobook_message(): string {
		return Dotdigital_WordPress_Config::get_option(
			Dotdigital_WordPress_Config::SETTING_MESSAGES_PATH . '[dm_API_nobook_message]'
		);
	}
	...
	public function get_subscribe_button_title(): string {
		return Dotdigital_WordPress_Config::get_option(
			Dotdigital_WordPress_Config::SETTING_MESSAGES_PATH . '[dm_API_subs_button]'
		);
	}
}
