...
- We audited the plugin using WordPress' Plugin Check (PCP) tool.

= 7.4.0 =

**What's new**
- We added an integration with reCAPTCHA v3 for spam protection.

**Improvements**
- We changed references to 'popover' mode to 'popup' in the Surveys, Pages, and Forms block.

= 7.3.4 =

**Bug fixes**
- Removed faulty line for email label on signup form.
